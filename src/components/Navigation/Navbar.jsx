    ...
    return (
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            ...
            <div onClick={()=>{
                ...
                className='lg:h-16 h-10 bg-black relative lg:w-[10vw] w-48'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div className='relative h-full lg:pl-24 px-16 flex flex-col justify-center items-end lg:gap-1.5 gap-0.5'>
